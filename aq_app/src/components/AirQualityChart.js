...
function WeatherComponent({ aqiData: propAqiData, city, loading: propLoading, error: propError, riskScore }) {
  ...
  return (
    <div className="card" style={{boxShadow: '0 4px 12px rgba(116,192,252,0.15)', borderRadius: '12px', border: 'none', width: '100%', maxWidth: 900, animation: 'fadeIn 0.8s'}}>
      <div className="card-body" style={{background: 'linear-gradient(to right, rgba(116,192,252,0.05), rgba(116,192,252,0.1))', borderRadius: '12px', minHeight: 380, display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '24px 18px 0px 18px'}}>
        <h4 className="card-title mb-3 text-center" style={{color: '#1976d2', fontWeight: 700, fontSize: 26, letterSpacing: 0.2, display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
          <i className="fa-solid fa-cloud me-2"></i>{city} 10-Day AQI Forecast
        </h4>
